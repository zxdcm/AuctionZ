...
namespace AuctionZ.Migrations
{
    ...
    [Migration("20181213225537_LotFieldChanged")]
    partial class LotFieldChanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Lot", b =>
                {
                    b.Property<int>("LotId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Bid", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Lot", "Lot")
                        .WithMany("Bids")
                        .HasForeignKey("LotId")
